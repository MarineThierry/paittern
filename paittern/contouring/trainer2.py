...
from paittern.contouring.model import deeplabv3_plus
...
STORAGE_LOCATION = 'models/contouring/contouring.joblib'

def upload_model_to_gcp():
    client = storage.Client()
    bucket = client.bucket(BUCKET_NAME)
    blob = bucket.blob(STORAGE_LOCATION)
    blob.upload_from_filename('contouring.joblib')
...
def save_model(reg):
    ...
    # Implement here
    joblib.dump(reg, 'contouring.joblib')
    print("saved contouring.joblib locally")
